 ...
 */ !(function (e) {
    ...
    ((e.fn.fileinputLocales = {}),
        ...
        (String.prototype.setTokens = function (e) {
            ...
            for (i in e)
                e.hasOwnProperty(i) &&
                    ((t = new RegExp('{' + i + '}', 'g')), (a = a.replace(t, e[i])));
            return a;
        }));
    var i, t;
    ((i = {
        ...
        hasDragDropSupport: function () {
            ...
            return (
                !i.isIE(9) &&
                (void 0 !== e.draggable || (void 0 !== e.ondragstart && void 0 !== e.ondrop))
            );
        },
        ...
        dataURI2Blob: function (e) {
            ...
            return (
                ...
                d
                    ? new Blob([i.hasArrayBufferViewSupport() ? n : a], { type: o })
        ...
        (t = function (t, a) {
            ...
            ((n.$element = e(t)),
                n._validate() &&
                    ((n.isPreviewable = i.hasFileAPISupport()),
                    (n.isIE9 = i.isIE(9)),
                    (n.isIE10 = i.isIE(10)),
                    n.isPreviewable || n.isIE9
                        ? (n._init(a), n._listen())
        ...
        (t.prototype = {
            ...
            _init: function (t) {
                ...
                ((o.options = t),
                    ...
                    o.rtl &&
                        ((r = o.previewZoomButtonIcons.prev),
                        (o.previewZoomButtonIcons.prev = o.previewZoomButtonIcons.next),
                        (o.previewZoomButtonIcons.next = r)),
                    o._cleanup(),
                    (o.$form = l.closest('form')),
                    o._initTemplateDefaults(),
                    (o.uploadFileAttr = i.isEmpty(l.attr('name')) ? 'file_data' : l.attr('name')),
                    (n = o._getLayoutTemplate('progress')),
                    (o.progressTemplate = n.replace('{class}', o.progressClass)),
                    (o.progressCompleteTemplate = n.replace('{class}', o.progressCompleteClass)),
                    (o.progressErrorTemplate = n.replace('{class}', o.progressErrorClass)),
                    (o.dropZoneEnabled = i.hasDragDropSupport() && o.dropZoneEnabled),
                    (o.isDisabled = l.attr('disabled') || l.attr('readonly')),
                    o.isDisabled && l.attr('disabled', !0),
                    (o.isUploadable = i.hasFileUploadSupport() && !i.isEmpty(o.uploadUrl)),
                    (o.isClickable =
                        o.browseOnZoneClick &&
                        o.showPreview &&
                        ((o.isUploadable && o.dropZoneEnabled) ||
                            !i.isEmpty(o.defaultPreviewContent))),
                    (o.slug =
                        'function' == typeof t.slugCallback ? t.slugCallback : o._slugDefault),
                    (o.mainTemplate = o.showCaption
                        ? o._getLayoutTemplate('main1')
                        : o._getLayoutTemplate('main2')),
                    (o.captionTemplate = o._getLayoutTemplate('caption')),
                    (o.previewGenericTemplate = o._getPreviewTemplate('generic')),
                    o.resizeImage &&
                        (o.maxImageWidth || o.maxImageHeight) &&
                        ((o.imageCanvas = document.createElement('canvas')),
                        (o.imageCanvasContext = o.imageCanvas.getContext('2d'))),
                    i.isEmpty(l.attr('id')) && l.attr('id', i.uniqId()),
                    (o.namespace = '.fileinput_' + l.attr('id').replace(/-/g, '_')),
                    void 0 === o.$container
                        ? (o.$container = o._createContainer())
                        : o._refreshContainer(),
                    (a = o.$container),
                    (o.$dropZone = a.find('.file-drop-zone')),
                    (o.$progress = a.find('.kv-upload-progress')),
                    (o.$btnUpload = a.find('.fileinput-upload')),
                    (o.$captionContainer = i.getElement(
                        t,
                        'elCaptionContainer',
                        a.find('.file-caption')
                    )),
                    (o.$caption = i.getElement(t, 'elCaptionText', a.find('.file-caption-name'))),
                    (o.$previewContainer = i.getElement(
                        t,
                        'elPreviewContainer',
                        a.find('.file-preview')
                    )),
                    (o.$preview = i.getElement(
                        t,
                        'elPreviewImage',
                        a.find('.file-preview-thumbnails')
                    )),
                    (o.$previewStatus = i.getElement(
                        t,
                        'elPreviewStatus',
                        a.find('.file-preview-status')
                    )),
                    (o.$errorContainer = i.getElement(
                        t,
                        'elErrorContainer',
                        o.$previewContainer.find('.kv-fileinput-error')
                    )),
                    i.isEmpty(o.msgErrorClass) || i.addCss(o.$errorContainer, o.msgErrorClass),
                    o.$errorContainer.hide(),
                    (o.previewInitId = 'preview-' + i.uniqId()),
                    o._initPreviewCache(),
                    o._initPreview(!0),
                    o._initPreviewActions(),
                    o._setFileDropZoneTitle(),
                    l.removeClass('file-loading'),
                    l.attr('disabled') && o.disable(),
                    o._initZoom(),
                    o.hideThumbnailContent && i.addCss(o.$preview, 'hide-content'));
            },
            _initTemplateDefaults: function () {
                ...
                ((t =
                    ...
                    (r = '<i class="glyphicon glyphicon-file kv-caption-icon"></i>'),
                    (l =
                    ...
                    (k =
                        ...
                        '>{data}</textarea>\n'),
                    (P =
                        '<video class="kv-preview-data file-preview-video" width="{width}" height="{height}" controls>\n<source src="{data}" type="{type}">\n' +
                        i.DEFAULT_PREVIEW +
                        '\n</video>\n'),
                    (z =
                    ...
                    (U =
                        ...
                        i.DEFAULT_PREVIEW +
                        '\n</div>\n'),
                    (j = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div>'),
                    ...
                    (L.defaults = {
                        ...
                        fileTypeSettings: {
                            image: function (e, t) {
                                return (
                                    i.compare(e, 'image.*') || i.compare(t, /\.(gif|png|jpe?g)$/i)
                                );
                            },
                            html: function (e, t) {
                            ...
                            text: function (e, t) {
                                return (
                                    i.compare(e, 'text.*') ||
                                    i.compare(t, /\.(xml|javascript)$/i) ||
                                    i.compare(t, /\.(txt|md|csv|nfo|ini|json|php|js|css)$/i)
                                );
                            },
                            video: function (e, t) {
                                return (
                                    i.compare(e, 'video.*') &&
                                    (i.compare(e, /(ogg|mp4|mp?g|mov|webm|3gp)$/i) ||
                                        i.compare(t, /\.(og?|mp4|webm|mp?g|mov|3gp)$/i))
                                );
                            },
                            audio: function (e, t) {
                                return (
                                    i.compare(e, 'audio.*') &&
                                    (i.compare(t, /(ogg|mp3|mp?g|wav)$/i) ||
                                        i.compare(t, /\.(og?|mp3|mp?g|wav)$/i))
                                );
                            },
                            flash: function (e, t) {
                                return (
                                    i.compare(e, 'application/x-shockwave-flash', !0) ||
                                    i.compare(t, /\.(swf)$/i)
                                );
                            },
                            pdf: function (e, t) {
                                return (
                                    i.compare(e, 'application/pdf', !0) || i.compare(t, /\.(pdf)$/i)
                                );
                            },
                            object: function () {
                                return !0;
                    ...
                    e.each(L.defaults, function (i, t) {
                        return 'allowedPreviewTypes' === i
                            ? void (void 0 === L.allowedPreviewTypes && (L.allowedPreviewTypes = t))
                            : void (L[i] = e.extend(!0, {}, t, L[i]));
                    }),
            ...
            _initPreviewTemplates: function () {
                ...
                e.each(n.previewContentTemplates, function (e, n) {
                    i.isEmpty(a.previewTemplates[e]) &&
                        ((t = r.tagBefore2),
                        ('generic' !== e && 'image' !== e && 'html' !== e && 'text' !== e) ||
                            (t = r.tagBefore1),
                        (a.previewTemplates[e] = t + n + o));
                });
            },
            _initPreviewCache: function () {
                ...
                ((t.previewCache = {
                    ...
                    count: function (e) {
                        return t.previewCache.data && t.previewCache.data.content
                            ? e
                                ? t.previewCache.data.content.length
                                : t.previewCache.fetch().length
                            : 0;
                    },
                    get: function (a, n) {
                        var r,
                            ...
                            w = function (e, a, n, r, o, l, s, d, c) {
                                return (
                                    (d =
                                        ' file-preview-initial ' + i.SORT_CSS + (d ? ' ' + d : '')),
                                    t._generatePreviewTemplate(e, a, n, r, o, !1, null, d, l, s, c)
                                );
                            };
                        return v
                            ? ((n = void 0 === n ? !0 : n),
                              (l = i.ifSet('type', m, t.initialPreviewFileType || 'generic')),
                              (d = i.ifSet('filename', m, i.ifSet('caption', m))),
                              (c = i.ifSet('filetype', m, l)),
                              (s = t.previewCache.footer(a, n, (m && m.size) || null)),
                              (u = i.ifSet('frameClass', m)),
                              (r = g
                                  ? w(l, v, d, c, h, s, p, u)
                                  : w('generic', v, d, c, h, s, p, u, l).setTokens({
                                        content: f.content[a],
                                    })),
                              f.tags.length && f.tags[a] && (r = i.replaceTags(r, f.tags[a])),
                              i.isEmpty(m) ||
                                  i.isEmpty(m.frameAttr) ||
                    ...
                    add: function (e, a, n, r) {
                        var o,
                            l = t.previewCache.data;
                        return (
                            i.isArray(e) || (e = e.split(t.initialPreviewDelimiter)),
                            r
                                ? ((o = l.content.push(e) - 1), (l.config[o] = a), (l.tags[o] = n))
                                : ((o = e.length - 1),
                                  (l.content = e),
                                  (l.config = a),
                                  (l.tags = n)),
                            (t.previewCache.data = l),
                            o
                        );
                    },
                    ...
                    unset: function (e) {
                        ...
                        if (i) {
                            if (1 === i)
                                return (
                                    (t.previewCache.data.content = []),
                                    (t.previewCache.data.config = []),
                                    (t.previewCache.data.tags = []),
                                    (t.initialPreview = []),
                                    (t.initialPreviewConfig = []),
                                    void (t.initialPreviewThumbTags = [])
                                );
                            ((t.previewCache.data.content[e] = null),
                                (t.previewCache.data.config[e] = null),
                                (t.previewCache.data.tags[e] = null));
                        }
                    },
                    out: function () {
                        var e,
                        ...
                        return (
                            (e = t._getMsgSelected(t.previewCache.count())),
                            { content: a, caption: e }
                        );
                    },
                    footer: function (e, a, n) {
                        var r = t.previewCache.data;
                        if (!r || !r.config || 0 === r.config.length || i.isEmpty(r.config[e]))
                            return '';
                        a = void 0 === a ? !0 : a;
                        var o,
                            l = r.config[e],
                            ...
                            g = c === !1 && a;
                        return (
                            (o = t._renderFileActions(!1, m, v, h, g, c, u, !0)),
                            t
            ...
            _errorsExist: function () {
                var i,
                    t = this;
                return t.$errorContainer.find('li').length
                    ? !0
                    : ((i = e(document.createElement('div')).html(t.$errorContainer.html())),
                      i.find('span.kv-error-close').remove(),
                      i.find('ul').remove(),
                    ...
                    a.code === a.NOT_FOUND_ERR
                        ...
                        : a.code === a.SECURITY_ERR
                          ...
                          : a.code === a.NOT_READABLE_ERR
                            ? t.msgFileNotReadable
                            : a.code === a.ABORT_ERR
                              ? t.msgFilePreviewAborted
                              : t.msgFilePreviewError
                );
            },
            _addError: function (e) {
                ...
                e &&
                    ...
                    i._handler(t.find('.kv-error-close'), 'click', function () {
                        t.fadeOut('slow');
                    }));
            },
            ...
            _showFolderError: function (e) {
                var t,
                    ...
                    n = a.$errorContainer;
                e &&
                    ((t = a.msgFoldersNotAllowed.replace('{n}', e)),
                    a._addError(t),
                    i.addCss(a.$container, 'has-error'),
                    n.fadeIn(800),
                    a._raise('filefoldererror', [e, t]));
            },
            _showUploadError: function (e, t, a) {
                ...
                return (
                    ...
                    i.addCss(n.$container, 'has-error'),
                    !0
                );
            },
            _showError: function (e, t, a) {
                ...
                return (
                    ...
                    r.fadeIn(800),
                    n._raise(o, [t, e]),
                    n.isUploadable || n._clearFileInput(),
                    n.$container.removeClass('file-input-new'),
                    i.addCss(n.$container, 'has-error'),
                    n.$btnUpload.attr('disabled', !0),
                    !0
                );
            },
            _noFilesError: function (e) {
                ...
                (t._addError(n),
                    ...
                    r.fadeIn(800),
                    t._raise('fileerror', [e, n]),
                    t._clearFileInput(),
                    i.addCss(t.$container, 'has-error'));
            },
            _parseError: function (i, t, a, n) {
                var r,
                    ...
                    l = e.trim(a + ''),
                    s =
                        void 0 !== t.responseJSON && void 0 !== t.responseJSON.error
                ...
                return (
                    ...
                    o.showAjaxErrorDetails &&
                        ...
                        (l += l ? r : s)),
                    l || (l = o.msgAjaxError.replace('{operation}', i)),
                    (o.cancelling = !1),
                    n ? '<b>' + n + ': </b>' + l : l
                );
            },
                ...
                return (
                    i &&
                        ...
                        a.previewFileIconSettings &&
                            (n =
                                a.previewFileIconSettings[t] ||
                                a.previewFileIconSettings[t.toLowerCase()] ||
                                null),
                        a.previewFileExtSettings &&
                            e.each(a.previewFileExtSettings, function (e, i) {
                                return a.previewFileIconSettings[e] && i(t)
            ...
            _raise: function (i, t) {
                var a = this,
                    n = e.Event(i);
                if (
                    (void 0 !== t ? a.$element.trigger(n, t) : a.$element.trigger(n),
            ...
            _listenFullScreen: function (e) {
                ...
                n &&
                    n.length &&
                    ((i = n && n.find('.btn-fullscreen')),
                    (t = n && n.find('.btn-borderless')),
                    i.length &&
                        t.length &&
            ...
            _listen: function () {
                ...
                (a._handler(n, 'change', e.proxy(a._change, a)),
                    ...
                    a._initDragDrop(),
                    a._handler(r, 'reset', e.proxy(a.reset, a)),
                    a.isUploadable || a._handler(r, 'submit', e.proxy(a._submitForm, a)),
                    a._handler(
            ...
            _initClickable: function () {
                var t,
                    a = this;
                a.isClickable &&
                    ((t = a.isUploadable ? a.$dropZone : a.$preview.find('.file-default-preview')),
                    i.addCss(t, 'clickable'),
                    t.attr('tabindex', -1),
                    a._handler(t, 'click', function (i) {
                        var n = e(i.target);
                        (n.parents('.file-preview-thumbnails').length &&
                            !n.parents('.file-default-preview').length) ||
                            (a.$element.trigger('click'), t.blur());
                    }));
            },
            _initDragDrop: function () {
                ...
                i.isUploadable &&
                    i.dropZoneEnabled &&
                    i.showPreview &&
                    (i._handler(t, 'dragenter dragover', e.proxy(i._zoneDragEnter, i)),
                    i._handler(t, 'dragleave', e.proxy(i._zoneDragLeave, i)),
                    i._handler(t, 'drop', e.proxy(i._zoneDrop, i)),
            ...
            _zoneDragEnter: function (t) {
                ...
                return (
                    a._zoneDragDropInit(t),
                    a.isDisabled || !n
                        ? ((t.originalEvent.dataTransfer.effectAllowed = 'none'),
                          void (t.originalEvent.dataTransfer.dropEffect = 'none'))
                        : void i.addCss(a.$dropZone, 'file-highlighted')
                );
            },
            _zoneDragLeave: function (e) {
                var i = this;
                (i._zoneDragDropInit(e),
                    i.isDisabled || i.$dropZone.removeClass('file-highlighted'));
            },
            _zoneDrop: function (e) {
                var t = this;
                (e.preventDefault(),
                    t.isDisabled ||
                        i.isEmpty(e.originalEvent.dataTransfer.files) ||
                        (t._change(e, 'dragdrop'), t.$dropZone.removeClass('file-highlighted')));
            },
            ...
            _initSortable: function () {
                ...
                window.KvSortable &&
                    ...
                    ((t = {
                        ...
                        onSort: function (t) {
                            var n,
                                ...
                                o = t.oldIndex,
                                l = t.newIndex;
                            ((a.initialPreview = i.moveArray(a.initialPreview, o, l)),
                                (a.initialPreviewConfig = i.moveArray(
                    ...
                    e.extend(!0, t, a.fileActionSettings.dragSettings),
                    n.kvsortable(t));
            },
            _initPreview: function (e) {
                ...
                return a.previewCache.count()
                    ? ((t = a.previewCache.out()),
                      (n = e && a.initialCaption ? a.initialCaption : t.caption),
                      a.$preview.html(t.content),
                      a._setInitThumbAttr(),
                      a._setCaption(n),
                      a._initSortable(),
                      void (i.isEmpty(t.content) || a.$container.removeClass('file-input-new')))
            ...
            _getZoomButton: function (e) {
                ...
                return (
                    ('fullscreen' !== e && 'borderless' !== e && 'toggleheader' !== e) ||
                        (r += ' data-toggle="button" aria-pressed="false" autocomplete="off"'),
            ...
            _initZoom: function () {
                ...
                a.showPreview &&
                    ...
                    (a.$modal && a.$modal.length) ||
                        ((t = e(document.createElement('div')).html(n).insertAfter(a.$container)),
                        (a.$modal = e(r).insertBefore(t)),
                        t.remove()),
                    i.initModal(a.$modal),
            ...
            _setZoomContent: function (t, a) {
                ...
                ((r = y.attr('data-template') || 'generic'),
                    ...
                    h.data('previewId', v));
                var T = s.find('img');
                (T.length && i.adjustOrientedImage(T, !0),
                    m._handler(g, 'click', function () {
                        ...
                        var e,
                            ...
                            n = function (e) {
                                ...
                                (h.hasClass('file-zoom-fullscreen') &&
                                    ((a = t.outerHeight(!0)), e || (a -= i.outerHeight(!0))),
                    ...
                    m._handler(h, 'keydown', function (e) {
                        ...
                        (37 !== i || g.attr('disabled') || m._zoomSlideShow('prev', v),
                            39 !== i || w.attr('disabled') || m._zoomSlideShow('next', v));
                    }));
            },
            ...
            _zoomSlideShow: function (i, t) {
                ...
                if (!l.attr('disabled')) {
                    ...
                    0 > r ||
                        ...
                        o._initZoomButtons(),
                        o._raise('filezoom' + i, { previewId: t, modal: o.$modal }));
                }
            },
            ...
            _resetPreview: function () {
                var e,
                    i,
                    t = this;
                (t.previewCache.count()
                    ? ((e = t.previewCache.out()),
                      t.$preview.html(e.content),
                      t._setInitThumbAttr(),
                      (i = t.initialCaption ? t.initialCaption : e.caption),
                      t._setCaption(i))
                    : (t._clearPreview(), t._initCaption()),
                    t.showPreview && (t._initZoom(), t._initSortable()));
            },
            ...
            _validateDefaultPreview: function () {
                var e = this;
                e.showPreview &&
                    !i.isEmpty(e.defaultPreviewContent) &&
                    (e.$preview.html(
                        '<div class="file-default-preview">' + e.defaultPreviewContent + '</div>'
                    ),
            ...
            _resetPreviewThumbs: function (e) {
                var i,
                    t = this;
                return e
                    ? (t._clearPreview(), void t.clearStack())
                    : void (t._hasInitialPreview()
                          ? ((i = t.previewCache.out()),
            ...
            _getMsgSelected: function (e) {
                ...
                return e > 0
                    ? i.msgSelected.replace('{n}', e).replace('{files}', t)
                        ...
                        e.upload.addEventListener(
                            ...
                            function (e) {
                                ...
                                (e.lengthComputable && (n = Math.floor((o / r) * 100)),
                                    i ? a._setAsyncUploadStatus(i, n, t) : a._setProgress(n));
                            },
                            !1
                        ),
                    e
            ...
            _initUploadSuccess: function (t, a, n) {
                ...
                m.showPreview &&
                    ...
                    ((m.hasInitData = !0),
                    (c = t.initialPreview || []),
                    (u = t.initialPreviewConfig || []),
                    (p = t.initialPreviewThumbTags || []),
                    (r = !(void 0 !== t.append && !t.append)),
                    c.length > 0 && !i.isArray(c) && (c = c.split(m.initialPreviewDelimiter)),
                    ...
                    void 0 !== a
                        ? n
                            ...
                            : ((l = m.previewCache.add(c, u[0], p[0], r)),
                              ...
                              a.fadeOut('slow', function () {
                                  ...
                                  (e &&
                                      e.length &&
                                      e.insertBefore(a).fadeIn('slow').css('display:inline-block'),
                                      m._initPreviewActions(),
                                      m._clearFileInput(),
                                      i.cleanZoomCache(m.$preview.find('#zoom-' + a.attr('id'))),
                                      a.remove(),
                                      s.remove(),
                                      m._initSortable());
                              }))
                        : (m.previewCache.set(c, u, p, r),
                          m._initPreview(),
                          m._initPreviewActions()));
            },
            _initSuccessThumbs: function () {
                var t = this;
                t.showPreview &&
                    t._getThumbs(i.FRAMES + '.file-preview-success').each(function () {
                        var a = e(this),
                            n = t.$preview,
                            r = a.find('.kv-file-remove');
                        (r.removeAttr('disabled'),
                            t._handler(r, 'click', function () {
                                var e = a.attr('id'),
                                    r = t._raise('filesuccessremove', [
                                        e,
                                ...
                                (i.cleanMemory(a),
                                    r !== !1 &&
                                        a.fadeOut('slow', function () {
                                            (i.cleanZoomCache(n.find('#zoom-' + e)),
                                                a.remove(),
                                                t.getFrames().length || t.reset());
                                        }));
                            }));
                    });
            },
            _checkAsyncComplete: function () {
                ...
                for (t = 0; t < a.filestack.length; t++)
                    if (
                        a.filestack[t] &&
                        ((i = a.previewInitId + '-' + t), -1 === e.inArray(i, a.uploadLog))
                    )
                        return !1;
                    ...
                    0 === h ||
                            ...
                            v.fileBatchCompleted &&
                                ...
                                setTimeout(function () {
                                    ...
                                    if (v.showPreview) {
                                        if (
                                            ...
                                            for (t = 0; t < n.content.length; t++)
                                                ((a = t + r),
                                                    (o.content[a] = n.content[t]),
                                                    o.config.length && (o.config[a] = n.config[t]),
                                                    o.tags.length && (o.tags[a] = n.tags[t]));
                                            ((v.initialPreview = i.cleanArray(o.content)),
                                                (v.initialPreviewConfig = i.cleanArray(o.config)),
                                                (v.initialPreviewThumbTags = i.cleanArray(o.tags)));
                                        } else
                                    ...
                                    (v.unlock(l),
                                        ...
                                        v.uploadAsync &&
                                            e.length &&
                                            (i.addCss(e, i.SORT_CSS), v._initSortable()),
                            ...
                            ((n = v._getOutData(o)),
                                ...
                                v.showPreview &&
                                    (r.hasClass('file-preview-success') ||
                                        ...
                                        i.addCss(r, 'file-uploading')),
                                    l.attr('disabled', !0),
                                    s.attr('disabled', !0)),
                                a || v.lock(),
                                v._raise('filepreupload', [n, w, t]),
                                e.extend(!0, C, n),
                        ...
                        (c = function (o, s, d) {
                            ...
                            ((n = v._getOutData(d, o)),
                                e.extend(!0, C, n),
                                setTimeout(function () {
                                    i.isEmpty(o) || i.isEmpty(o.error)
                                        ? (v.showPreview &&
                                              (v._setThumbStatus(r, 'Success'),
                                              l.hide(),
                                              v._initUploadSuccess(o, r, a),
                                              v._setProgress(101, b)),
                                          v._raise('fileuploaded', [n, c, t]),
                                          a ? f(t, c) : v.updateStack(t, void 0))
                                        : ((m = !0),
                                          v._showUploadError(o.error, C),
                                          v._setPreviewError(r, t, y ? null : v.filestack[t]),
                                          a && f(t, c));
                                }, 100));
                        }),
                        (u = function () {
                        ...
                        (p = function (i, n, o) {
                            var l = v.ajaxOperations.uploadThumb,
                                s = v._parseError(
                                    ...
                                    i,
                                    o,
                                    a && v.filestack[t].name ? v.filestack[t].name : null
                                );
                            ((m = !0),
                                setTimeout(function () {
                                    (a && f(t, w),
                                        ...
                                        v._setPreviewError(r, t, y ? null : v.filestack[t]),
                                        e.extend(!0, C, v._getOutData(i)),
                                        v._setProgress(
                                            101,
                                            b,
                                            v.msgAjaxProgressError.replace('{operation}', l)
                                        ),
                                        v._showUploadError(s, C));
                                }, 100));
                        }),
                        g.append(v.uploadFileAttr, v.filestack[t], v.filenames[t]),
                        g.append('file_id', t),
                        v._ajaxSubmit(d, c, u, p, w, t)));
            },
                ...
                ((l.formdata = new FormData()),
                    0 !== d &&
                            ...
                            (l.showPreview &&
                                l._getThumbs().each(function () {
                                    ...
                                    (t.hasClass('file-preview-success') ||
                                        (l._setThumbStatus(t, 'Loading'),
                                        i.addCss(t, 'file-uploading')),
                                        a.attr('disabled', !0),
                                        n.attr('disabled', !0));
                                }),
                                l._raise('filebatchpreupload', [a]),
                                l._abort(a) && (t.abort(), l._setProgressCancelled()));
                        }),
                        (a = function (t, a, n) {
                                ...
                                : (l.showPreview &&
                                      (s.each(function () {
                                          ...
                                          return (
                                              ...
                                              t.removeAttr('disabled'),
                                              0 === c.length
                                                  ? void l._setPreviewError(i)
                                                  : (-1 !== e.inArray(d, c)
                                                        ? l._setPreviewError(i)
                                                        : (i.find('.kv-file-upload').hide(),
                                                          l._setThumbStatus(i, 'Success'),
                                                          l.updateStack(d, void 0)),
                                                    void d++)
                                          );
                                      }),
                                      l._initUploadSuccess(t)),
                                  l._showUploadError(t.error, r, 'filebatchuploaderror'));
                        }),
                        (r = function () {
                            (l.unlock(),
                            ...
                            (l._showUploadError(o, n, 'filebatchuploaderror'),
                                ...
                                l.showPreview &&
                                    (l._getThumbs().each(function () {
                                        ...
                                        (i.removeClass('file-uploading'),
                                            void 0 !== l.filestack[t] && l._setPreviewError(i));
                                    }),
                        ...
                        e.each(s, function (e, t) {
                            i.isEmpty(s[e]) ||
                                l.formdata.append(l.uploadFileAttr, t, l.filenames[e]);
                        }),
            ...
            _deleteFileIndex: function (t) {
                ...
                'init_' === n.substring(0, 5) &&
                    ...
                    (a.initialPreview = i.spliceArray(a.initialPreview, n)),
                    (a.initialPreviewConfig = i.spliceArray(a.initialPreviewConfig, n)),
                    (a.initialPreviewThumbTags = i.spliceArray(a.initialPreviewThumbTags, n)),
                    a.getFrames().each(function () {
                        var i = e(this),
                            t = i.attr('data-fileindex');
                        'init_' === t.substring(0, 5) &&
                            ((t = parseInt(t.replace('init_', ''))),
                            t > n && (t--, i.attr('data-fileindex', 'init_' + t)));
                    }),
            ...
            _initFileActions: function () {
                ...
                t.showPreview &&
                    (t._initZoomButton(),
                    t.getFrames(' .kv-file-remove').each(function () {
                        var n,
                            r,
                            o,
                            l,
                        ...
                        t._handler(s, 'click', function () {
                            return (
                                (l = t._raise('filepreremove', [c, u])),
                                l !== !1 && t._validateMinCount()
                                    ? ((n = d.hasClass('file-preview-error')),
                                      i.cleanMemory(d),
                                      void d.fadeOut('slow', function () {
                                          (i.cleanZoomCache(a.find('#zoom-' + c)),
                                              t.updateStack(u, void 0),
                                              t._clearObjects(d),
                                              d.remove(),
                                              c &&
                                                  n &&
            ...
            _initPreviewActions: function () {
                var t = this,
                    ...
                    o = function () {
                        var e = t.isUploadable
                            ? t.previewCache.count()
                            : t.$element.get(0).files.length;
                    ...
                    a.find(r).each(function () {
                        ...
                        if (!i.isEmpty(l) && void 0 !== s) {
                            var d,
                                ...
                                u,
                                p,
                                f = r.closest(i.FRAMES),
                                m = t.previewCache.data,
                                v = f.attr('data-fileindex');
                            ((v = parseInt(v.replace('init_', ''))),
                                (u =
                                    i.isEmpty(m.config) && i.isEmpty(m.config[v])
                                        ? null
                                        : m.config[v]),
                                (p = i.isEmpty(u) || i.isEmpty(u.extra) ? n : u.extra),
                                'function' == typeof p && (p = p()),
                                (c = { id: r.attr('id'), key: s, extra: p }),
                                (d = e.extend(
                                    !0,
                                    {},
                                    {
                                        ...
                                        beforeSend: function (e) {
                                            ((t.ajaxAborted = !1),
                                                t._raise('filepredelete', [s, e, p]),
                                                t._abort()
                                                    ? e.abort()
                                                    : (i.addCss(f, 'file-uploading'),
                                                      i.addCss(r, 'disabled')));
                                        },
                                        success: function (e, n, l) {
                                            var d, u;
                                            return i.isEmpty(e) || i.isEmpty(e.error)
                                                ? ((v = parseInt(
                                                      f.attr('data-fileindex').replace('init_', '')
                                                  )),
                                                  t.previewCache.unset(v),
                                                  (d = t.previewCache.count()),
                                                  (u = d > 0 ? t._getMsgSelected(d) : ''),
                                                  t._deleteFileIndex(f),
                                                  t._setCaption(u),
                                                  t._raise('filedeleted', [s, l, p]),
                                                  f
                                                      .removeClass('file-uploading')
                                                      .addClass('file-deleted'),
                                                  void f.fadeOut('slow', function () {
                                                      (i.cleanZoomCache(
                                                          a.find('#zoom-' + f.attr('id'))
                                                      ),
                                                          t._clearObjects(f),
                                                          f.remove(),
                                                          o(),
                                                          d ||
                                                              0 !== t.getFileStack().length ||
                                                              (t._setCaption(''), t.reset()));
                                                  }))
                                                : ((c.jqXHR = l),
                                                  (c.response = e),
                                                  t._showError(e.error, c, 'filedeleteerror'),
                                        ...
                                        error: function (e, i, a) {
                                            ...
                                            ((c.jqXHR = e),
                                                (c.response = {}),
                                                t._showError(r, c, 'filedeleteerror'),
                                                f.removeClass('file-uploading'),
                                                o());
                                        },
                                    },
                                ...
                                t._handler(r, 'click', function () {
                                    return t._validateMinCount()
                                        ? ((t.ajaxAborted = !1),
                                          t._raise('filebeforedelete', [s, p]),
                                          void (t.ajaxAborted instanceof Promise
                                              ? t.ajaxAborted.then(function (i) {
                                                    i === !1 && e.ajax(d);
                                                })
                                              : t.ajaxAborted === !1 && e.ajax(d)))
                                        : !1;
                                }));
                        }
                    }));
            ...
            _getSize: function (i) {
                var t,
                    ...
                    o = parseFloat(i),
                    l = r.fileSizeGetter;
                return e.isNumeric(i) && e.isNumeric(o)
                    ? ('function' == typeof l
                          ? (n = l(o))
                          : 0 === o
                            ? (n = '0.00 B')
                            : ((t = Math.floor(Math.log(o) / Math.log(1024))),
                              (a = ['B', 'KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB']),
                              (n = 1 * (o / Math.pow(1024, t)).toFixed(2) + ' ' + a[t])),
            ...
            _generatePreviewTemplate: function (t, a, n, r, o, l, s, d, c, u, p) {
                var f,
                    ...
                    x = function (a, l, s, c) {
                        var f = s ? 'zoom-' + o : o,
                            ...
                            g = (d || '') + ' ' + c;
                        return (
                            m.frameClass && (g = m.frameClass + ' ' + g),
                            s && (g = g.replace(' ' + i.SORT_CSS, '')),
                            (h = m._parseFilePreviewIcon(h, n)),
                            'text' === a && (l = i.htmlEncode(l)),
                            'object' !== t ||
                                r ||
                                e.each(m.defaults.fileTypeSettings, function (e, i) {
                ...
                return (
                    ...
                    m.fileActionSettings.showZoom &&
                        (h = x(E ? 'other' : t, a, !0, 'kv-zoom-thumb')),
                    (h = '\n' + m._getLayoutTemplate('zoomCache').replace('{zoomContent}', h)),
                    (f = x(T ? 'other' : t, a, !1, 'kv-preview-thumb')),
                    f + h
                );
            },
            _previewDefault: function (t, a, n) {
                ...
                if (r.showPreview) {
                    ...
                    (r._clearDefaultPreview(),
                        (l = r._generatePreviewTemplate('other', f, s, d, a, p, c)),
                        o.append('\n' + l),
                        r._setThumbAttr(a, u, c),
                        n === !0 && r.isUploadable && r._setThumbStatus(e('#' + a), 'Error'));
                }
            },
            _previewFile: function (e, t, a, n, r) {
                if (this.showPreview) {
                    ...
                    if (
                        ...
                        ((o = l._generatePreviewTemplate(s, g, d, h, n, !1, v)),
                            l._clearDefaultPreview(),
                            f.append('\n' + o));
                        var _ = f.find('#' + n + ' img');
                        _.length && l.autoOrientImage
                            ? i.validateOrientation(t, function (e) {
                                  ...
                                  (e > 4 &&
                                      ...
                                      i.addCss(_, r),
                                      i.addCss(a, r),
                                      l._raise('fileimageoriented', { $img: _, file: t }),
                                      l._validateImage(n, c, h, v, g),
                                      i.adjustOrientedImage(_));
                              })
                            : l._validateImage(n, c, h, v, g);
            ...
            _setThumbAttr: function (i, t, a) {
                var n = this,
                    r = e('#' + i);
                r.length &&
                    ((a = a && a > 0 ? n._getSize(a) : ''), r.data({ caption: t, size: a }));
            },
                ...
                if (0 !== l)
                    for (var s = 0; l > s; s++)
                        ((e = o.config[s]),
                            ...
                            (t = i.ifSet('caption', e, i.ifSet('filename', e))),
                            (a = i.ifSet('size', e)),
                            r._setThumbAttr(n, t, a));
            },
                ...
                var a,
                    ...
                    y = function (i, r, o, l) {
                        ...
                        return (
                            ...
                            n._initFileActions(),
                            n.removeFromPreviewOnError && e('#' + o).remove(),
                            n.isUploadable ? n._showUploadError(i, s) : n._showError(i, d)
                        );
                    };
                ((n.loadedImages = []),
                    ...
                    (a = function (e) {
                        if ((i.isEmpty(r.attr('multiple')) && (f = 1), e >= f))
                            return (
                                n.isUploadable && n.filestack.length > 0
                                    ? n._raise('filebatchselected', [n.getFileStack()])
                                    : n._raise('filebatchselected', [t]),
                                s.removeClass('file-thumb-loading'),
                                void d.html('')
                            );
                        var T,
                        ...
                        if (g > 0)
                            for (F = 0; g > F; F++)
                                ((P = h[F]),
                                    (z = n.msgFileTypes[P] || P),
                                    (Z += 0 === F ? z : ', ' + z));
                        if (j === !1) return void a(e + 1);
                        if (0 === j.length)
                            return (
                                (S = n.msgInvalidFileName.replace('{name}', i.htmlEncode(U.name))),
                                void (n.isError = y(S, U, D, e))
                            );
                        if (
                            (i.isEmpty(w) || (L = new RegExp('\\.(' + w.join('|') + ')$', 'i')),
                            (x = B.toFixed(2)),
                            n.maxFileSize > 0 && B > n.maxFileSize)
                        )
                            return (
                        ...
                        if (null !== n.minFileSize && B <= i.getNum(n.minFileSize))
                            return (
                        ...
                        if (!i.isEmpty(h) && i.isArray(h)) {
                            for (F = 0; F < h.length; F += 1)
                                ((I = h[F]),
                                    (A = m[I]),
                                    (R +=
                                        A && 'function' == typeof A && A(U.type, U.name) ? 1 : 0));
                            if (0 === R)
                                return (
                                    (S = n.msgInvalidFileType.setTokens({ name: j, types: Z })),
                                    void (n.isError = y(S, U, D, e))
                                );
                        }
                        return 0 !== R ||
                            ...
                            !i.isArray(w) ||
                            i.isEmpty(L) ||
                            ((k = i.compare(j, L)), (R += i.isEmpty(k) ? 0 : k.length), 0 !== R)
                            ? n.showPreview
                                ? !C && B > b
                                    ? (n.addToStack(U),
                                      s.addClass('file-thumb-loading'),
                                      n._previewDefault(U, D),
                                      n._initFileActions(),
                                      n._updateFileDetails(f),
                                      void a(e + 1))
                                    : (o.length && void 0 !== FileReader
                                          ? (d.html(
                                                c.replace('{index}', e + 1).replace('{files}', f)
                                            ),
                                            s.addClass('file-thumb-loading'),
                                          ...
                                          : (n._previewDefault(U, D),
                                            ...
                                            n._raise('fileloaded', [U, D, e, l])),
                                      void n.addToStack(U))
                                : (n.isUploadable && n.addToStack(U),
                                  setTimeout(function () {
                                      (a(e + 1), n._updateFileDetails(f));
                                  }, 100),
                                  void n._raise('fileloaded', [U, D, e, l]))
            ...
            _updateFileDetails: function (e) {
                ...
                (t.isError
                    ? (t.$previewContainer.removeClass('file-thumb-loading'),
                      t.$previewStatus.html(''),
                    ...
                    1 === arguments.length && t._raise('fileselect', [e, o]),
            ...
            _setThumbStatus: function (e, i) {
                ...
                if (t.showPreview) {
                    ...
                    (e.removeClass('file-preview-success file-preview-error file-preview-loading'),
                        ...
                        'Success' === i &&
                            (e.find('.file-drag-handle').remove(), o.css('margin-left', 0)),
                        o.html(l[a]),
                        o.attr('title', l[n]),
                        e.addClass(r));
                }
            ...
            _setFileDropZoneTitle: function () {
                var e,
                    ...
                    n = t.dropZoneTitle;
                (t.isClickable &&
                    ((e = i.isEmpty(t.$element.attr('multiple')) ? t.fileSingle : t.filePlural),
                    (n += t.dropZoneClickTitle.replace('{files}', e))),
                    a.find('.' + t.dropZoneTitleClass).remove(),
                    t.isUploadable &&
                        t.showPreview &&
                        0 !== a.length &&
                        !(t.getFileStack().length > 0) &&
                        t.dropZoneEnabled &&
                        (0 === a.find(i.FRAMES).length &&
                            i.isEmpty(t.defaultPreviewContent) &&
                            a.prepend('<div class="' + t.dropZoneTitleClass + '">' + n + '</div>'),
                        t.$container.removeClass('file-input-new'),
                        i.addCss(t.$container, 'file-input-ajax-new')));
            },
            _setAsyncUploadStatus: function (i, t, a) {
                var n = this,
                    r = 0;
                (n._setProgress(t, e('#' + i).find('.file-thumb-progress')),
                    (n.uploadStatus[i] = t),
                    e.each(n.uploadStatus, function (e, i) {
                        r += i;
                    }),
            ...
            _validateMinCount: function () {
                ...
                return e.validateInitialCount &&
                    e.minFileCount > 0 &&
                    e._getFileCount(i - 1) < e.minFileCount
                    ? (e._noFilesError({}), !1)
                    : !0;
            },
            ...
            _getFileId: function (e) {
                ...
                return 'function' == typeof a
                    ? a(e, event)
                    : e
                      ? ((i = e.webkitRelativePath || e.fileName || e.name || null),
            ...
            _checkDimensions: function (e, t, a, n, r, o, l) {
                ...
                !i.isEmpty(m) &&
                    ...
                    (u = 'Small' === t ? d >= m : m >= d),
                    u ||
                        ((s = p['msgImage' + o + t].setTokens({ name: r, size: m })),
                        p._showUploadError(s, l),
                        p._setPreviewError(n, e, null)));
            },
                    ...
                    m
                        .one('load', function () {
                            ((l = p.width()),
                                ...
                                l > s && m.css('width', '100%'),
                                (o = { ind: f, id: i }),
                                c._checkDimensions(f, 'Small', m, p, t, 'Width', o),
                                c._checkDimensions(f, 'Small', m, p, t, 'Height', o),
                                c.resizeImage ||
                                    (c._checkDimensions(f, 'Large', m, p, t, 'Width', o),
                                    c._checkDimensions(f, 'Large', m, p, t, 'Height', o)),
                                c._raise('fileimageloaded', [i]),
                ...
                if (r === a.totalImagesCount && (a._raise('fileimagesloaded'), a.resizeImage))
                    for (e = 0; e < a.loadedImages.length; e++)
                        ((i = a.loadedImages[e]),
                            i.validated ||
                                ((t = i.siz),
                                t && t > 1e3 * o && a._getResizedImage(i, n, r),
            ...
            _getResizedImage: function (t, a, n) {
                ...
                if (
                    ((d = function (e, i, t) {
                        (p.isUploadable ? p._showUploadError(e, i, t) : p._showError(e, i, t),
                            p._setPreviewError(x, E));
                    }),
                    (!p.filestack[E] || !_ || (g >= m && w >= v)) &&
                        (_ && p.filestack[E] && p._raise('fileimageresized', [T, E]),
                        a.val++,
                        a.val === n && p._raise('fileimagesresized'),
                        !_))
                )
                    return void d(
                ...
                try {
                    (C.drawImage(f, 0, 0, m, v),
                        ...
                        F && ((u = window.piexif.dump(F)), (s = window.piexif.insert(u, s))),
                        (r = i.dataURI2Blob(s)),
                        (p.filestack[E] = r),
                        p._raise('fileimageresized', [T, E]),
                        a.val++,
                        a.val === n && p._raise('fileimagesresized', [void 0, void 0]),
                        r instanceof Blob ||
                            d(p.msgImageResizeError, { id: T, index: E }, 'fileimageresizeerror'));
                } catch (S) {
                    (a.val++,
                        a.val === n && p._raise('fileimagesresized', [void 0, void 0]),
                        (c = p.msgImageResizeException.replace('{errors}', S.message)),
                        d(c, { id: T, index: E }, 'fileimageresizeexception'));
                }
            },
            ...
            _initCaption: function () {
                var e = this,
                    t = e.initialCaption || '';
                return e.overwriteInitial || i.isEmpty(t)
                    ? (e.$caption.html(''), !1)
                    : (e._setCaption(t), !0);
            },
            _setCaption: function (t, a) {
                ...
                if (s.$caption.length) {
                    if (a)
                        ((n = e('<div>' + s.msgValidationError + '</div>').text()),
                            (o = d.length),
                            (l = o
                                ? 1 === o && d[0]
                                    ? s._getFileNames()[0]
                                    : s._getMsgSelected(o)
                                : s._getMsgSelected(s.msgNo)),
                            (r =
                                '<span class="' +
                                s.msgValidationErrorClass +
                                '">' +
                                s.msgValidationErrorIcon +
                                (i.isEmpty(t) ? l : t) +
                                '</span>'));
                    else {
                        if (i.isEmpty(t)) return;
                        ((n = e('<div>' + t + '</div>').text()),
                            (r = s._getLayoutTemplate('fileIcon') + n));
                    }
                    (s.$caption.html(r),
                        s.$caption.attr('title', n),
                        s.$captionContainer.find('.file-caption-ellipsis').attr('title', n));
                }
            },
            _createContainer: function () {
                var i = this,
                    t = { class: 'file-input file-input-new' + (i.rtl ? ' kv-rtl' : '') },
                    a = e(document.createElement('div')).attr(t).html(i._renderMain());
                return (
                    i.$element.before(a),
                    i._initBrowse(a),
                    i.theme && a.addClass('theme-' + i.theme),
                    a
                );
            },
                ...
                var e = this,
                    ...
                    a = e.showPreview
                        ? e
                              ...
                              .setTokens({ class: e.previewClass, dropClass: i })
                        : '',
            ...
            _renderButton: function (e) {
                ...
                switch (e) {
                    ...
                    case 'upload':
                        ...
                        t.isUploadable && !t.isDisabled
                            ? (a = t._getLayoutTemplate('btnLink').replace('{href}', t.uploadUrl))
                            : (d = 'submit');
                        break;
                    case 'browse':
                ...
                return (
                    ...
                    i.isEmpty(l) ||
                        (l = ' <span class="' + t.buttonLabelClass + '">' + l + '</span>'),
                    a.setTokens({ type: d, css: n, title: r, status: s, icon: o, label: l })
                );
            },
            ...
            _renderFileActions: function (e, i, t, a, n, r, o, l) {
                ...
                var s,
                    ...
                    w = d.otherActionButtons.setTokens({ dataKey: u }),
                ...
                return (
                    ...
                    a &&
                        l &&
                        ((s = 'drag-handle-init ' + g.dragClass),
                        (v = d
            ...
            _browse: function (e) {
                ...
                (i._raise('filebrowse'),
                    (e && e.isDefaultPrevented()) ||
                        (i.isError && !i.isUploadable && i.clear(), i.$captionContainer.focus()));
            },
            ...
            _change: function (t) {
                var a = this,
                    n = a.$element;
                if (!a.isUploadable && i.isEmpty(n.val()) && a.fileInputCleared)
                ...
                if (
                    ...
                    a._hideFileIcon(),
                    a.isUploadable &&
                        a.$container.find('.file-drop-zone .' + a.dropZoneTitleClass).remove(),
                    c
                        ? e.each(p, function (e, i) {
                              i && !i.type && void 0 !== i.size && i.size % 4096 === 0
                                  ? h++
                                  : a._filterDuplicate(i, d, g);
                          })
                        : ((p =
                              t.target && void 0 === t.target.files
                                  ? t.target.value
                          ...
                          u
                              ...
                              : (d = p)),
                    i.isEmpty(d) || 0 === d.length)
                )
                    return (u || a.clear(), a._showFolderError(h), void a._raise('fileselectnone'));
                if (
                    (a._resetErrors(),
                    (s = d.length),
                    (o = a._getFileCount(a.isUploadable ? a.getFileStack().length + s : s)),
            ...
            _resetFileStack: function () {
                ...
                (t._getThumbs().each(function () {
                    ...
                    '-1' !== d &&
                        ...
                        (void 0 !== c
                            ? ((n[a] = c),
                              (r[a] = t._getFileName(c)),
                              (o[a] = t._getFileId(c)),
                              s.attr({ id: t.previewInitId + '-' + a, 'data-fileindex': a }),
                              a++)
                            : ((l = 'uploaded-' + i.uniqId()),
            ...
            _isFileSelectionValid: function (e) {
                ...
                return (
                    (e = e || 0),
                    i.required && !i.getFilesCount()
                        ? (i.$errorContainer.html(''), i._showUploadError(i.msgFileRequired), !1)
                        : i.minFileCount > 0 && i._getFileCount(e) < i.minFileCount
                          ? (i._noFilesError({}), !1)
                          : !0
                );
            },
            ...
            updateStack: function (e, i) {
                ...
                return (
                    (t.filestack[e] = i),
                    (t.filenames[e] = t._getFileName(i)),
                    (t.fileids[e] = (i && t._getFileId(i)) || null),
                    t.$element
                );
            },
            addToStack: function (e) {
                ...
                return (
                    i.filestack.push(e),
                    i.filenames.push(i._getFileName(e)),
                    i.fileids.push(i._getFileId(e)),
                    i.$element
                );
            },
            ...
            lock: function () {
                ...
                return (
                    e._resetErrors(),
                    e.disable(),
                    e.showRemove && i.addCss(e.$container.find('.fileinput-remove'), 'hide'),
            ...
            unlock: function (e) {
                ...
                return (
                    void 0 === e && (e = !0),
                    t.enable(),
                    t.showCancel && i.addCss(t.$container.find('.fileinput-cancel'), 'hide'),
                    ...
                    return (
                        ...
                        a._hasInitialPreview()
                            ...
                            : (a._getThumbs().each(function () {
                              ...
                              a.isUploadable && (a.previewCache.data = {}),
                              a.$preview.html(''),
                              (t =
                              ...
                              i.addCss(a.$container, 'file-input-new'),
                              a._validateDefaultPreview()),
                        0 === a.$container.find(i.FRAMES).length &&
                            (a._initCaption() ||
                                a.$captionContainer.find('.kv-caption-icon').hide()),
                        a._hideFileIcon(),
            ...
            reset: function () {
                ...
                if (e._raise('filereset'))
                    return (
                        ...
                        i.addCss(e.$container, 'file-input-new'),
                        (e.getFrames().length || (e.isUploadable && e.dropZoneEnabled)) &&
                            e.$container.removeClass('file-input-new'),
                        e.clearStack(),
                        (e.formdata = {}),
            ...
            upload: function () {
                ...
                if (r.isUploadable && !r.isDisabled && r._isFileSelectionValid(o)) {
                    ...
                    for (
                        ...
                        ((r.uploadCache.content[t] = null),
                            (r.uploadCache.config[t] = null),
                            (r.uploadCache.tags[t] = null));
                    for (
                        r.$preview.find('.file-preview-initial').removeClass(i.SORT_CSS),
                            r._initSortable(),
                        ...
                        r.filestack[t] && r._uploadSingle(t, !0);
                }
            },
            destroy: function () {
                var i = this,
                ...
                return (
                    ...
                    e(window).off(r),
                    t && t.length && t.off(r),
                    i.isUploadable && i._clearFileInput(),
                    i._cleanup(),
                    i._initPreviewCache(),
            ...
            refresh: function (i) {
                var t = this,
                    a = t.$element;
                return (
                    (i = i ? e.extend(!0, {}, t.options, i) : t.options),
                    t.destroy(),
                    a.fileinput(i),
                    (t = a.data('fileinput')),
                    t.isUploadable && t._clearFileInput(),
                ...
                switch (
                    ...
                    this.each(function () {
                        ...
                        (s ||
                            ...
                            'en' === f ||
                                i.isEmpty(e.fn.fileinputLocales[f]) ||
