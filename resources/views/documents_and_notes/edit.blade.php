<div class="modal-dialog modal-lg"
     role="document">
    {!! Form::open([
        'url' => action([\App\Http\Controllers\DocumentAndNoteController::class, 'update'], $document_note->id),
        'id' => 'docus_notes_form',
        'method' => 'put',
    ]) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('description', $document_note->description, [
                            'class' => 'form-control ',
                            'id' => 'docs_note_description',
                        ]) !!}
                    </div>
                </div>
            </div>
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox"
                                           name="is_private"
                                           value="1"
                                           @if ($document_note->is_private) checked @endif> @lang('lang_v1.is_private')
