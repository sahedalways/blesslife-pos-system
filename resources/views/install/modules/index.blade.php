...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">
            ...
            <small class="tw-text-sm md:tw-text-base tw-text-gray-700 tw-font-semibold">Only superadmin can access manage
                modules</small>
        </h1>
        <!-- <ol class="breadcrumb">
        ...
        <a class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pull-right tw-mt-4"
           href="{{ action([\App\Http\Controllers\Install\ModulesController::class, 'regenerate']) }}">
            <i class="fas fa-tools"></i>
            Regenerate @show_tooltip("<br />1. Regenerate/publish modules css/js to fix not found issue. <br /> 2. Publish
            api module oauth files")
        </a>
    </section>
                ...
                @component('components.widget')
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            &nbsp;
                            <button type="button"
                                    class="tw-dw-btn tw-dw-btn-error tw-text-white tw-dw-btn-sm cancel_upload_btn">
                    ...
                    <table class="table">
                        ...
                        @foreach ($modules as $module)
                            ...
                            --}}
                                    ...
                                    <form action="{{ action([\App\Http\Controllers\Install\ModulesController::class, 'destroy'], ['module_name' => $module['name']]) }}"
                                          style="display: inline;"
                                          method="post"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button onclick="window.open('{{ $mod->u }}', '_blank')"
                                                class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline tw-dw-btn-accent"><i
                                               class="fas fa-money-bill"></i> Buy</button>
                                    </td>
                                    <td>
                                        {{ $mod->d }}
                                    </td>
