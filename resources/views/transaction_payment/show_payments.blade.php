                ...
                @if ($transaction->type == 'purchase')
                    <div class="row no-print">
                        <div class="col-md-12 text-right">
                            <button type="button"
                                    class="tw-dw-btn tw-dw-btn-info tw-text-white tw-dw-btn-xs btn-modal"
                            ...
                            @forelse ($payments as $payment)
                                <tr>
                                    ...
                                    <td class="no-print"
                                        ...
                                        @if (
                                            (in_array($transaction->type, ['gym_subscription']) &&
                                                auth()->user()->can('gym.delete_gym_subscription_payment')) ||
                                        ...
                                        @if (!empty($payment->document_path))
                                            ...
                                            @if (isFileImage($payment->document_name))
                                                ...
                                                <button data-href="{{ $payment->document_path }}"
                                                        ...
                                                        data-toggle="tooltip"
                                                        title="{{ __('lang_v1.view_document') }}"><i
