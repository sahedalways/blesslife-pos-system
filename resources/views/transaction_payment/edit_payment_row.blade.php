<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::hidden(
            ...
            !empty($transaction->location) ? $transaction->location->default_payment_accounts : '[]',
        ...
        <div class="modal-body">
            <div class="row">
                @if (!empty($transaction->contact))
                    <div class="col-md-4">
                        <div class="well">
                            <strong>
                                @if ($transaction->contact->type == 'supplier')
            ...
            <div class="row payment_row">
                ...
                @if (
                    ...
                    <input type="hidden"
                           class="enable_cash_denomination_for_payment_methods"
                                ...
                                <tbody>
                                    ...
                                    @foreach (explode(',', $pos_settings['cash_denominations']) as $dnm)
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! Form::number("denominations[$dnm]", $count, [
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden"
                                                   class="denomination_total_amount"
                                                   value="{{ $total }}">
                                            <input type="hidden"
                                                   class="is_strict"
