...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\InvoiceLayoutController::class, 'update'], [$invoice_layout->id]),
            'method' => 'put',
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="design"
                                ...
                                @foreach ($designs as $key => $label)
                                    <option value="{{ $key }}"
                                            @if ($key === $invoice_layout->design) selected @endif
                        ...
                        <div class="form-group @if ($invoice_layout->design != 'columnize-taxes') hide @endif"
                             id="columnize-taxes">
                            <div class="col-md-3">
                                <input type="text"
                                       class="form-control"
                                       ...
                                       value="{{ $invoice_layout->table_tax_headings[0] }}"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('previous_balance_due_label', $invoice_layout->previous_balance_due_label, [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('show_previous_balance_due', 1, $invoice_layout->show_previous_balance_due, [
                                        'class' => 'input-icheck',
                                    ]) !!} @lang('lang_v1.show_previous_balance_due')</label>
                    ...
                    <div class="col-sm-3 @if ($invoice_layout->design != 'slim') hide @endif"
                         id="hide_price_div">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                        ...
                        <div class="form-group">
                            <label>
                                {!! Form::checkbox(
                                    ...
                                    ['class' => 'input-icheck'],
                                ) !!} @lang('lang_v1.show_total_in_words')</label>
