...
@section('content')
    ...
    <section class="content">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\InvoiceLayoutController::class, 'store']),
            'method' => 'post',
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="design"
                                ...
                                @foreach ($designs as $key => $label)
                                    <option value="{{ $key }}"
                                            @if ($key === 'classic') selected @endif
                                            @if (isset($has_number_formatter) && !$has_number_formatter && $key === 'english-arabic') disabled @endif>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            @endif
                            <small id="english_arabic_message"
                                   style="display: none; color: green; font-size: 12px;">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('show_letter_head', 1, false, ['class' => 'input-icheck', 'id' => 'show_letter_head']) !!} @lang('lang_v1.show_letter_head')</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('common_settings[discounted_unit_price_label]', 'Price after discount', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('product_custom_fields[]', 'product_custom_field1', false, ['class' => 'input-icheck']) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('product_custom_fields[]', 'product_custom_field2', false, ['class' => 'input-icheck']) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('product_custom_fields[]', 'product_custom_field3', false, ['class' => 'input-icheck']) !!}
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('product_custom_fields[]', 'product_custom_field4', false, ['class' => 'input-icheck']) !!}
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::text('previous_balance_due_label', null, [
                                'class' => 'form-control',
                                'placeholder' => __('lang_v1.previous_balance_due'),
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-sm-6 hide">
                        <div class="form-group">
                            ...
                            {!! Form::text('highlight_color', '#000000', [
                                'class' => 'form-control',
        ...
        @component('components.widget', ['class' => 'box-solid', 'title' => __('lang_v1.qr_code')])
            <div class="row">
                ...
                <div class="col-sm-4"
                     id="zatca_phase_container"
                     style="display: none;">
                    <div class="form-group">
                        {!! Form::label('zatca_phase', __('lang_v1.zatca_phase') . ':*') !!}
                        {!! Form::select(
                            'common_settings[zatca_phase]',
                            [
                                'phase_1' => __('lang_v1.zatca_phase1'),
                                'phase_2' => __('lang_v1.zatca_phase2'),
                            ],
                            $invoice_layout->common_settings['zatca_phase'] ?? null,
                            ['class' => 'form-control', 'id' => 'zatca_phase'],
                        ) !!}
                        <small id="phase2_message"
                               style="display: none; color: green; font-size: 12px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('cn_heading', 'Credit Note', [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('cn_no_label', __('purchase.ref_no'), [
                                'class' => 'form-control',
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::text('cn_amount_label', 'Credit Amount', [
                                'class' => 'form-control',
