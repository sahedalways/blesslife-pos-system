<div class="modal fade"
    ...
    <div class="modal-dialog"
        ...
        <div class="modal-content">
            {!! Form::open([
                'url' => action([\App\Http\Controllers\ProductController::class, 'updateProductLocation']),
                'method' => 'post',
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><span class="add_to_location_title hide">@lang('lang_v1.add_location_to_the_selected_products')</span><span
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    {!! Form::select('product_location[]', $business_locations, null, [
                        'class' => 'form-control',
                        'style' => 'width:100%',
                        'required',
                        'multiple',
            ...
            <div class="modal-footer">
                <button type="submit"
                        ...
                        id="update_product_location">@lang('messages.save')</button>
                <button type="button"
