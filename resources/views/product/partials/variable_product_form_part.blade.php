    ...
    <div class="option-div-group">
        <div class="col-md-12">
            <label class="form-check-label"
                   for="sku">@lang('product.variation_sku_format') </label>@show_tooltip(__('product.variation_sku_format_help_text'))
        </div>
        <div class="col-sm-4">
            <input class="form-check-input"
                   ...
                   name="sku_type"
                   checked
                   id="with_out_variation"
                   value="with_out_variation">
            <label class="form-check-label"
                   for="with_out_variation">@lang('product.sku_number')</label>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <label class="form-check-label"
                       for="with_variation">@lang('product.sku_variation_number')</label>
            </div>
        </div>
    </div>
</div>
...
<div class="col-sm-12">
    <h4>@lang('product.add_variation'):* <button type="button"
...
<div class="col-sm-12">
    <div class="table-responsive">
        <table class="table table-bordered add-product-price-table table-condensed"
               id="product_variation_form_part">
            <thead>
                <tr>
                    <th></th>
