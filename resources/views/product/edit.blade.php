                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button"
                                        @if (!auth()->user()->can('unit.create')) disabled @endif
                ...
                <div class="col-sm-4 @if (!session('business.enable_brand')) hide @endif">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button"
                                        @if (!auth()->user()->can('brand.create')) disabled @endif
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                @elseif($cf_type == 'dropdown')
                                    ...
                                    <select name="{{ $db_field_name }}"
                                            id="{{ $db_field_name }}"
                                            class="form-control select2">
                                        @foreach ($dropdown as $option)
                                            <option value="{{ $option }}"
                                                    @if ($option == $product->$db_field_name) selected @endif>{{ $option }}
                                            </option>
                                        @endforeach
                                    </select>
                                @endif
                ...
                <div class="text-center">
                    <div class="btn-group">
                        ...
                        @can('product.opening_stock')
                            <button type="submit"
                                    @if (empty($product->enable_stock)) disabled="true" @endif
