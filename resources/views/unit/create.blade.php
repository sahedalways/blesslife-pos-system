<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\UnitController::class, 'store']),
            'method' => 'post',
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    ...
                    {!! Form::select('allow_decimal', ['1' => __('messages.yes'), '0' => __('messages.no')], null, [
                    ...
                    <div class="form-group col-sm-12 hide"
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    {!! Form::select('base_unit_id', $units, null, [
