<!-- Static navbar -->
<nav
     class="navbar-default navbar-static-top tw-transition-all tw-duration-5000 tw-shrink-0 tw-rounded-2xl tw-m-[16px] tw-border-2 tw-bg-white">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"
               href="/">{{ config('app.name', 'ultimatePOS') }}</a>
        </div>
        <div id="navbar"
