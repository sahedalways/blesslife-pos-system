                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-4">
                                <br>
                                <button type="submit"
                                        class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('lang_v1.upload_and_review')</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <br>
                            <a href="{{ asset('files/import_sales_template.xlsx') }}"
                                ...
                                <tr>
                                    ...
                                    @can('sell.delete')
                                        <td><a href="{{ action([\App\Http\Controllers\ImportSalesController::class, 'revertSaleImport'], $key) }}"
                                               class="tw-dw-btn tw-dw-btn-outline tw-dw-btn-xs tw-dw-btn-error revert_import"><i
                                                   class="fas fa-undo"></i> @lang('lang_v1.revert_import')</a></td>
                                    @endcan
                                </tr>
                            @endforeach
                        </tbody>
