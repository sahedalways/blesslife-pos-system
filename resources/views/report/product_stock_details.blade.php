...
@section('content')
            ...
            <div class="col-md-12">
                <div class="box box-primary"
                    ...
                    <div id="collapseFilter"
                         class="panel-collapse active collapse in"
                         aria-expanded="true">
                        <div class="box-body">
                            <div class="row">
                                {!! Form::open([
                                    'url' => action([\App\Http\Controllers\ReportController::class, 'productStockDetails']),
                                    'method' => 'get',
                                ]) !!}
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::select('location_id', $business_locations, !empty($location) ? $location->id : null, [
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <br>
                                        <button type="submit"
                                                class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('lang_v1.search')</button>
                                    </div>
                                </div>
                                {!! Form::close() !!}
                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                @foreach ($stock_details as $row)
                                                    @php
                                                        $stock_mismatch =
                                                            round($row->stock) - round($row->total_stock_calculated);
                                                    @endphp
                                                    @if ($stock_mismatch == 0)
                                                        @continue
                                                    @endif
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @if ($row->type == 'variable')
                                                                {{ $row->product_variation }} - {{ $row->variation_name }}
                                                                ({{ $row->sub_sku }})
                                                            @else
                                                                ({{ $row->sku }})
                                                            @endif
                                                        ...
                                                        <td>
                                                            <a href="{{ action([\App\Http\Controllers\ReportController::class, 'adjustProductStock']) }}?location_id={{ $location->id }}&variation_id={{ $row->variation_id }}&stock={{ $row->total_stock_calculated }}"
                                                               class="btn btn-primary">Fix</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </table>
    ...
    <!-- /.content -->
    <div class="modal fade view_register"
         tabindex="-1"
         role="dialog"
