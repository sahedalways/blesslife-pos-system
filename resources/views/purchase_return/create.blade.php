...
@section('content')
    ...
    <section class="content no-print">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\CombinedPurchaseReturnController::class, 'save']),
            'method' => 'post',
                            ...
                            <table class="table table-bordered table-striped table-condensed"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><i class="fa fa-trash"
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <button type="button"
                        ...
                        class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white">@lang('messages.submit')</button>
            </div>
        </div>
        {!! Form::close() !!}
    </section>
