    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="modalTitle"> @lang('lang_v1.purchase_return_details') (<b>@lang('purchase.ref_no'):</b>
                #{{ $purchase->return_parent->ref_no ?? $purchase->ref_no }})
            </h4>
        </div>
            ...
            <div class="row">
                @if (!empty($purchase->return_parent))
                    <div class="col-sm-6 col-xs-6">
                        ...
                        <strong>@lang('lang_v1.return_date'):</strong>
                        {{ @format_date($purchase->return_parent->transaction_date) }}<br>
                        ...
                        <tbody>
                            ...
                            @foreach ($purchase->purchase_lines as $purchase_line)
                                ...
                                <tr>
                                    ...
                                    <td>{{ @format_quantity($purchase_line->quantity_returned) }} {{ $unit_name }}
                                    </td>
                                    <td>
                                        @php
                                            $line_total =
