                            ...
                            @foreach ($purchase->purchase_lines as $purchase_line)
                                ...
                                <tr>
                                    ...
                                    <td><span class="display_currency"
                                              ...
                                              data-is_quantity="true">{{ $qty_available }}</span> {{ $unit_name }}</td>
                                    <td>
                                        @php
                                            $check_decimal = 'false';
                                            if ($purchase_line->product->unit->allow_decimal == 0) {
			              			...
			              			data-msg-max-value="@lang('validation.custom-messages.quantity_not_available', ['qty' => $purchase_line->formatted_qty_available, 'unit' => $unit_name ])" @endif>
                                        <input type="hidden"
                                               class="unit_price"
