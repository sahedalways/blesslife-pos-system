                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            <input type="hidden"
                                   ...
                                   value="{{ $purchase_return->id }}">
                            <input type="hidden"
                                   id="location_id"
                                   value="{{ $purchase_return->location_id }}">
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button"
                        ...
                        class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white pull-right">@lang('messages.update')</button>
            </div>
        </div>
        {!! Form::close() !!}
    </section>
