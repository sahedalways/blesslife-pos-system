    ...
    <section class="content no-print">
        @component('components.filters', ['title' => __('report.filters')])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    {!! Form::select('so_list_filter_status', $sales_order_statuses, null, [
                        'class' => 'form-control select2',
                        'style' => 'width:100%',
                        'placeholder' => __('lang_v1.all'),
                    ]) !!}
            ...
            @if (!empty($shipping_statuses))
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('so_list_shipping_status', $shipping_statuses, null, [
                            'class' => 'form-control select2',
                            'style' => 'width:100%',
                            'placeholder' => __('lang_v1.all'),
                        ]) !!}
        ...
        @component('components.widget', ['class' => 'box-primary'])
            @can('so.create')
                @slot('tool')
                    <div class="box-tools">
                        <a class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-sm tw-text-white"
                           href="{{ action([\App\Http\Controllers\SellController::class, 'create']) }}?sale_type=sales_order">
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                '#sell_list_filter_location_id, #sell_list_filter_customer_id, #created_by, #so_list_filter_status, #so_list_shipping_status',
                function() {
                    sell_table.ajax.reload();
                });
        });
