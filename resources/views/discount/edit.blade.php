<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\DiscountController::class, 'update'], [$discount->id]),
            'method' => 'put',
            'id' => 'discount_form',
        ]) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('variation_ids[]', $variations, array_keys($variations), [
                            'id' => 'variation_ids',
                            'class' => 'form-control',
                            'multiple',
                        ]) !!}
                ...
                <div class="col-md-6 @if (!empty($variations)) hide @endif"
                     id="brand_input">
                    <div class="form-group">
                ...
                <div class="col-sm-6 @if (!empty($variations)) hide @endif"
                     id="category_input">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('location_id', $locations, $discount->location_id, [
                            'placeholder' => __('messages.please_select'),
                            'class' => 'form-control select2',
                            'required',
                        ]) !!}
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('priority', $discount->priority, [
                            'class' => 'form-control input_number',
                            'required',
                            'placeholder' => __('lang_v1.priority'),
                        ]) !!}
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('discount_amount', $discount->discount_amount, [
                            'class' => 'form-control input_number',
                            'required',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('starts_at', $starts_at, [
                            'class' => 'form-control discount_date',
                            'required',
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('ends_at', $ends_at, [
                            'class' => 'form-control discount_date',
                            'required',
                            'placeholder' => __('lang_v1.ends_at'),
                            'readonly',
                        ]) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="spg"
                                class="form-control">
                            <option value=""
                                    @if (is_null($discount->spg)) selected @endif>@lang('lang_v1.all')</option>
                            @foreach ($price_groups as $k => $v)
                                <option value="{{ $k }}"
                                        @if ($discount->spg === (string) $k) selected @endif>{{ $v }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
