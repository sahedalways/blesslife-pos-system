                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio(
                                        'radio_option[stock_adjustment_view]',
                                        'stock_adjustment.view',
                                        in_array('stock_adjustment.view', $role_permissions),
                                        ['class' => 'input-icheck'],
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio(
                                        ...
                                        in_array('view_own_stock_adjustment', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('stock_adjustment.create', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_adjustment.create') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('stock_adjustment.update', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_adjustment.update') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('stock_adjustment.delete', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_adjustment.delete') }}
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio(
                                        'radio_option[stock_transfer_view]',
                                        'stock_transfer.view',
                                        in_array('stock_transfer.view', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_transfer.view') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio(
                                        ...
                                        in_array('stock_transfer.view_own', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!}
                            ...
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('stock_transfer.create', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_transfer.create') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('stock_transfer.update', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_transfer.update') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox(
                                        ...
                                        in_array('stock_transfer.delete', $role_permissions),
                                        ['class' => 'input-icheck'],
                                    ) !!} {{ __('role.stock_transfer.delete') }}
                                </label>
                            </div>
                        </div>
                    </div>
