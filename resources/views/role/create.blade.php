                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-2">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox"
                                       class="check_all input-icheck"> {{ __('role.select_all') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-9">
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[purchase_view]', 'purchase.view', false, ['class' => 'input-icheck']) !!} {{ __('lang_v1.view_all_purchase') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[stock_adjustment_view]', 'view_own_stock_adjustment', false, [
                                        'class' => 'input-icheck',
                                    ]) !!}
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock_adjustment.create', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_adjustment.create') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock_adjustment.update', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_adjustment.update') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock_adjustment.delete', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_adjustment.delete') }}
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row check_group">
                    ...
                    <div class="col-md-9">
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[stock_transfer_view]', 'stock_transfer.view', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_transfer.view') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::radio('radio_option[stock_transfer_view]', 'stock_transfer.view_own', false, [
                                        'class' => 'input-icheck',
                                    ]) !!}
                        ...
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock_transfer.create', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_transfer.create') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock_transfer.update', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_transfer.update') }}
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="checkbox">
                                <label>
                                    {!! Form::checkbox('permissions[]', 'stock_transfer.delete', false, ['class' => 'input-icheck']) !!} {{ __('role.stock_transfer.delete') }}
                                </label>
                            </div>
                        </div>
                    </div>
