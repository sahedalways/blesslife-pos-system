<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\TypesOfServiceController::class, 'update'], $type_of_service->id),
            'method' => 'put',
            'id' => 'types_of_service_form',
        ]) !!}
        ...
        <div class="modal-body">
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    {!! Form::text('name', $type_of_service->name, [
                        'class' => 'form-control',
                        'required',
                ...
                <div class="form-group col-md-12">
                    ...
                    {!! Form::textarea('description', $type_of_service->description, [
                        'class' => 'form-control',
                        ...
                        <thead>
                            ...
                            @foreach ($locations as $key => $value)
                                <tr>
                                    <td>{{ $value }}</td>
                                    <td>{!! Form::select(
                                        'location_price_group[' . $key . ']',
                                        $price_groups,
                                        !empty($type_of_service->location_price_group[$key]) ? $type_of_service->location_price_group[$key] : null,
                ...
                <div class="form-group col-md-6">
                    ...
                    {!! Form::select(
                        ...
                        $type_of_service->packing_charge_type,
                        ['class' => 'form-control'],
                    ) !!}
                </div>
                <div class="form-group col-md-6">
                    ...
                    {!! Form::text(
                        'packing_charge',
                        !empty($type_of_service->packing_charge) ? @num_format($type_of_service->packing_charge) : '',
                        ['class' => 'form-control input_number', 'placeholder' => __('lang_v1.packing_charge')],
                    ) !!}
                </div>
                <div class="form-group col-md-12">
                    <div class="checkbox">
