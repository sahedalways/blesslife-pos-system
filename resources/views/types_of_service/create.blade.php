<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action([\App\Http\Controllers\TypesOfServiceController::class, 'store']),
            'method' => 'post',
                    ...
                    <table class="table table-slim">
                        <thead>
                            ...
                            @foreach ($locations as $key => $value)
                                <tr>
                                    <td>{{ $value }}</td>
                                    <td>{!! Form::select('location_price_group[' . $key . ']', $price_groups, null, [
