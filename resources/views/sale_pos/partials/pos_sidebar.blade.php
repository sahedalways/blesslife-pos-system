...
<div class="row tw-mb-1">
    @if (!empty($categories))
        <div class="col-md-6 !tw-px-2"
             id="product_category_div">
            <div class="tw-dw-drawer tw-dw-drawer-end">
                <input id="my-drawer-4"
                       type="checkbox"
                       class="tw-dw-drawer-toggle">
                <div class="tw-dw-drawer-content">
                    ...
                    <label for="my-drawer-4"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                             class="tw-w-5 icon icon-tabler icon-tabler-category-plus"
                             width="44"
                             height="44"
                             viewBox="0 0 24 24"
                             stroke-width="1.5"
                    ...
                    <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6">
                        <div class="tw-flex tw-items-center tw-mb-16">
                            <button type="button"
                                    ...
                                    style="display: none">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                     class="tw-w-5 icon icon-tabler icon-tabler-chevron-left"
                                     width="44"
                                     height="44"
                                     viewBox="0 0 24 24"
                                     stroke-width="1.5"
                            ...
                            <button type="button"
                                    class="tw-dw-btn tw-dw-btn-error close-side-bar-category">
    ...
    @if (!empty($brands))
        <div class="col-sm-6 !tw-px-2"
             id="product_brand_div">
            <div class="tw-dw-drawer tw-dw-drawer-end">
                <input id="my-drawer-brand"
                       type="checkbox"
                       class="tw-dw-drawer-toggle">
                <div class="tw-dw-drawer-content">
                    <!-- Page content here -->
                    <label for="my-drawer-brand"
                           class="tw-bg-gradient-to-r tw-from-indigo-600 tw-to-blue-500 hover:tw-from-indigo-600 hover:tw-to-blue-600 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-blue-500 focus:tw-ring-offset-2 active:tw-from-indigo-700 active:tw-to-blue-700 lg:tw-w-[98%] tw-w-full tw-flex tw-items-center tw-justify-center tw-gap-1 tw-text-base md:tw-text-lg tw-text-white tw-font-semibold tw-rounded-xl tw-h-12 tw-cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             class="tw-w-5 icon icon-tabler icon-tabler-brand-beats"
                             width="44"
                             height="44"
                             viewBox="0 0 24 24"
                             stroke-width="1.5"
                ...
                <div class="tw-dw-drawer-side"
                    ...
                    <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6">
                        ...
                        <div class="tw-flex tw-items-center tw-mb-16">
                            ...
                            <button type="button"
                                    class="tw-dw-btn tw-dw-btn-error close-side-bar-brand">
                                <i class="fa fa-times-circle"
                                   aria-hidden="true"></i>
                            </button>
                        </div>
    ...
    <div class="col-sm-4 @if (empty($featured_products)) hide @endif"
         id="feature_product_div">
        <button type="button"
