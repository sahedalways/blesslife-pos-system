        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row @if (!$is_rp_enabled) hide @endif">
                    <div class="well well-sm bg-light-gray col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    {!! Form::number('rp_redeemed_modal', $rp_redeemed, [
                                        'class' => 'form-control',
                        ...
                        <div class="col-md-6">
                            <p><strong>@lang('lang_v1.available'):</strong> <span id="available_rp">{{ $max_available }}</span>
                            </p>
                            <h5><strong>@lang('lang_v1.redeemed_amount'):</strong> <span
                                      id="rp_redeemed_amount_text">{{ @num_format($rp_redeemed_amount) }}</span></h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button"
                        ...
                        id="posEditDiscountModalUpdate">@lang('messages.update')</button>
                <button type="button"
