        ...
        <div class="modal-content">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text(
                                    ...
                                    !empty($transaction->shipping_charges) ? @num_format($transaction->shipping_charges) : 0,
                                    [
                                        'class' => 'form-control input_number input_number',
                                        'data-decimal' => 'no_neg',
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::text('delivered_to_modal', !empty($transaction->delivered_to) ? $transaction->delivered_to : null, [
                                'class' => 'form-control',
            ...
            <div class="modal-footer">
                <button type="button"
                        ...
                        id="posShippingModalUpdate">@lang('messages.update')</button>
                <button type="button"
