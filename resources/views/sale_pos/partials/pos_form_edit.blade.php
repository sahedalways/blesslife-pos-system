...
<div class="row">
    @if (!empty($pos_settings['show_invoice_layout']))
        <div class="col-md-4">
            <div class="form-group">
                {!! Form::select('invoice_layout_id', $invoice_layouts, $transaction->location->invoice_layout_id, [
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                <div class="input-group">
                    ...
                    {!! Form::text('transaction_date', @format_datetime($transaction->transaction_date), [
                        'class' => 'form-control',
                        'readonly',
                        'required',
                        'id' => 'transaction_date',
        ...
        <div class="col-md-4 col-sm-6">
            <div class="form-group">
                <div class="input-group">
                    ...
                    {!! Form::text('exchange_rate', @num_format($transaction->exchange_rate), [
    ...
    @if (in_array('kitchen', $enabled_modules))
        <div class="col-md-3">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('is_kitchen_order', 1, $transaction->is_kitchen_order, [
                            'class' => 'input-icheck status',
                            'id' => 'is_kitchen_order',
                        ]) !!} {{ __('lang_v1.kitchen_order') }}
                    </label>
                </div>
            </div>
        </div>
