...
<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' =>
                $notification_template['template_for'] == 'send_ledger'
                    ? action([\App\Http\Controllers\ContactController::class, 'sendLedger'])
                    : action([\App\Http\Controllers\NotificationController::class, 'send']),
            'method' => 'post',
        ...
        <div class="modal-body">
                        ...
                        <div class="box-body">
                            @if ($notification_template['template_for'] == 'send_ledger')
                                <div class="form-group">
                                    ...
                                    {!! Form::select(
                                        'ledger_format',
                                        ['format_1' => __('lang_v1.format_1'), 'format_2' => __('lang_v1.format_2')],
                                        $ledger_format,
                                        ['class' => 'form-control'],
                                    ) !!}
                                </div>
                        ...
                        <div id="sms_collapse"
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('mobile_number', $contact->mobile, [
                                        'class' => 'form-control',
                                ...
                                <div id="whatsapp_div"
                                    ...
                                    {!! Form::textarea('whatsapp_text', $notification_template['whatsapp_text'], [
                                        'class' => 'form-control',
                                        'placeholder' => __('lang_v1.whatsapp_text'),
                                        'rows' => 6,
                                    ]) !!}
                                </div>
                            </div>
            ...
            <div class="modal-footer">
                <button type="submit"
                        ...
                        id="send_notification_btn">@lang('lang_v1.send')</button>
                <button type="button"
