<div class="modal-dialog modal-lg"
    ...
    <div class="modal-content">
        {!! Form::open([
            'url' => action([\App\Http\Controllers\CashRegisterController::class, 'postCloseRegister']),
            'method' => 'post',
        ]) !!}
            ...
            <div class="row">
                @if (auth()->user()->can('view_cash_register'))
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::number('total_card_slips', $register_details->total_card_slips, [
                                'class' => 'form-control',
                                'required',
                                'placeholder' => __('cash_register.total_card_slips'),
                                'min' => 0,
                            ]) !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::number('total_cheques', $register_details->total_cheques, [
                                'class' => 'form-control',
                                'required',
                                'placeholder' => __('cash_register.total_cheques'),
                                'min' => 0,
                            ]) !!}
                        </div>
                    </div>
                        ...
                        @if (!empty($pos_settings['cash_denominations']))
                            <table class="table table-slim">
                                <thead>
                                    <tr>
                                        <th width="20%"
                                            class="text-right">@lang('lang_v1.denomination')</th>
                                        <th width="20%">&nbsp;</th>
                                        <th width="20%"
                                            class="text-center">@lang('lang_v1.count')</th>
                                        <th width="20%">&nbsp;</th>
                                        <th width="20%"
                                            class="text-left">@lang('sale.subtotal')</th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="4"
                                            class="text-center">@lang('sale.total')</th>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('closing_note', null, [
                            'class' => 'form-control',
                            'placeholder' => __('cash_register.closing_note'),
                            'rows' => 3,
                        ]) !!}
                    </div>
                </div>
