    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="modalTitle"> @lang('lang_v1.stock_transfer_details') (<b>@lang('purchase.ref_no'):</b> #{{ $sell_transfer->ref_no }})
            </h4>
        </div>
            ...
            <div class="row invoice-info">
                ...
                <div class="col-md-4 invoice-col">
                    ...
                    <address>
                        ...
                        @if (
                            !empty($location_details['purchase']->city) ||
                                !empty($location_details['purchase']->state) ||
                                !empty($location_details['purchase']->country))
                    ...
                    <div class="table-responsive">
                        <table class="table bg-gray">
                            <tr class="bg-green">
                                ...
                                <th>@lang('sale.qty')</th>
                                <th
                                    class="@cannot('view_purchase_price') show_price_with_permission no-print @endcan">@lang('sale.subtotal')</th>
				        </tr>
				        @php
				          $total = 0.00;
				        @endphp
                    ...
                    <div class="row print_section">
                        <div class="col-xs-12">
                            <img class="center-block"
                                 src="data:image/png;base64,{{ DNS1D::getBarcodePNG($sell_transfer->ref_no, 'C128', 2, 30, [39, 48, 54], true) }}">
                        </div>
                    </div>
                </div>
