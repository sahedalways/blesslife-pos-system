...
@section('content')
    ...
    <section class="content-header">
        <br>
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('barcode.print_labels')
            @show_tooltip(__('tooltip.print_label'))</h1>
        <!-- <ol class="breadcrumb">
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('barcode.info_in_labels')])
            <div class="row">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"
                                               checked
                                               name="print[name]"
                                               value="1"> <b>@lang('barcode.print_name')</b>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"
                                               ...
                                               value="1"> <b>@lang('barcode.print_variations')</b>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"
                                               ...
                                               name="print[price]"
                                               value="1"
                                               id="is_show_price"> <b>@lang('barcode.print_price')</b>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"
                                               ...
                                               value="1"> <b>@lang('barcode.print_business_name')</b>
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"
                                               ...
                                               value="1"> <b>@lang('lang_v1.print_packing_date')</b>
                                    </label>
                                </div>
                                ...
                                @if (request()->session()->get('business.enable_lot_number') == 1)
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox"
                                                   checked
                                                   name="print[lot_number]"
                                                   value="1"> <b>@lang('lang_v1.print_lot_number')</b>
                                        </label>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox"
                                                   checked
                                                   name="print[exp_date]"
                                                   value="1"> <b>@lang('lang_v1.print_exp_date')</b>
                                        </label>
                                    </div>
                ...
                <div class="col-sm-12 text-center">
                    <button type="button"
                            id="labels_preview"
                            class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-lg tw-text-white">@lang('barcode.preview')</button>
                </div>
            </div>
        @endcomponent
        {!! Form::close() !!}
