<div class="modal-dialog"
    ...
    <div class="modal-content">
        ...
        {!! Form::open([
            'url' => action(
                [\App\Http\Controllers\Restaurant\ProductModifierSetController::class, 'update'],
                [$modifer_set->id],
            ),
            'method' => 'post',
            'id' => 'table_add_form',
                            ...
                            @foreach ($modifer_set->modifier_products as $product)
                                <tr>
                                    ...
                                    <td><button type="button"
                                                class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-error remove_modifier_product"><i
    ...
    $(document).ready(function() {
        $("#search_product").autocomplete({
                source: function(request, response) {
                    $.getJSON("/products/list-no-variation", {
                        term: request.term
                    }, response);
                },
                minLength: 2,
