        ...
        <div class="row">
            @if (!$is_service_staff)
                @component('components.widget')
                    <div class="col-sm-6">
                        {!! Form::open([
                            'url' => action([\App\Http\Controllers\Restaurant\OrderController::class, 'index']),
                            'method' => 'get',
                            'id' => 'select_service_staff_form',
                        ]) !!}
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                {!! Form::select('service_staff', $service_staff, request()->service_staff, [
            ...
            @component('components.widget', ['title' => __('lang_v1.line_orders')])
                ...
                <div class="row"
                     id="line_orders_div">
                    @include('restaurant.partials.line_orders', ['orders_for' => 'waiter'])
                </div>
            ...
            @component('components.widget', ['title' => __('restaurant.all_your_orders')])
                ...
                <div class="row"
                     id="orders_div">
                    @include('restaurant.partials.show_orders', ['orders_for' => 'waiter'])
                </div>
                <div class="overlay hide">
                    <i class="fas fa-sync fa-spin"></i>
                </div>
