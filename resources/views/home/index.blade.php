...
@section('content')
    ...
    <div class="tw-pb-6 xl:tw-pb-0" style="background: linear-gradient(135deg, #f0f7f0 0%, #b8d8b8 100%);">
            ...
            @if ($is_admin)
                <div class="tw-relative">
                    <div class="tw-absolute tw-inset-0 tw-grid" aria-hidden="true">
                        <div style="background: linear-gradient(135deg, #f0f7f0 0%, #b8d8b8 100%);"></div>
                        <div class="xl:tw-bg-none xl:tw-bg-gray-100" style="background: linear-gradient(135deg, #f0f7f0 0%, #b8d8b8 100%);">
                        </div>
                    </div>
