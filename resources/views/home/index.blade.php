...
@section('content')
    ...
    <div class="tw-pb-6 xl:tw-pb-0"
         style="background: linear-gradient(135deg, #e8ecf1 0%, #d5dde8 100%);">
        <div class="tw-px-5 tw-pt-3">
            ...
            <div class="sm:tw-flex sm:tw-items-center sm:tw-justify-between sm:tw-gap-12">
                <div class="tw-mt-2 sm:tw-w-1/2 md:tw-w-1/2">
                    <h1 class="tw-text-2xl md:tw-text-4xl tw-tracking-tight tw-font-semibold tw-mb-10 md:tw-mb-0"
                        style="color: #333333;">
                        @php
                            $hour = \Carbon\Carbon::now('Asia/Riyadh')->format('H');
                            if ($hour < 12) {
                                $greeting = 'Good Morning';
                                $icon = '<svg class="tw-size-5 md:tw-size-6 tw-inline-block tw-ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>';
                            } elseif ($hour < 18) {
                                $greeting = 'Good Afternoon';
                                $icon = '<svg class="tw-size-5 md:tw-size-6 tw-inline-block tw-ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>';
                            } else {
                                $greeting = 'Good Evening';
                                $icon = '<svg class="tw-size-5 md:tw-size-6 tw-inline-block tw-ml-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>';
                            }
                        @endphp
                        {{ $greeting }}, {{ Session::get('user.first_name') }}! {!! $icon !!}
                    </h1>
                </div>
        ...
        @if (auth()->user()->can('dashboard.data'))
            @if ($is_admin)
                <div class="tw-relative">
                    <div class="tw-absolute tw-inset-0 tw-grid"
                         aria-hidden="true">
                        <div style="background: linear-gradient(135deg, #e8ecf1 0%, #d5dde8 100%);"></div>
                        <div class="xl:tw-bg-none xl:tw-bg-gray-100"
                             style="background: linear-gradient(135deg, #e8ecf1 0%, #d5dde8 100%);">
                        </div>
                    </div>
                        ...
                        <div class="tw-p-4 sm:tw-p-5">
                            <div class="tw-flex tw-items-center tw-gap-2.5">
                                <div
                                    ...
                                    <svg aria-hidden="true"
                                         class="tw-text-yellow-500 tw-size-5 tw-shrink-0"
                                         xmlns="http://www.w3.org/2000/svg"
                                         viewBox="0 0 24 24"
                                         stroke-width="2"
                                         stroke="currentColor"
...
<div class="modal fade edit_pso_status_modal"
     tabindex="-1"
     role="dialog"></div>
