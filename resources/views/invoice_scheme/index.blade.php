...
@section('content')
    ...
    <section class="content">
                    ...
                    <div class="">
                        ...
                        <div class="tab-content">
                                            ...
                                            <table class="table table-bordered table-striped"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>@lang('invoice.number_type') @show_tooltip(__('invoice.number_type_tooltip'))
                                                        </th>
                            ...
                            <div class="tab-pane"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4>@lang('invoice.all_your_invoice_layouts') <a
                                               class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pull-right"
        ...
        <div class="modal fade invoice_modal"
             tabindex="-1"
             role="dialog"
             aria-labelledby="gridSystemModalLabel">
        </div>
        <div class="modal fade invoice_edit_modal"
             tabindex="-1"
             role="dialog"
             aria-labelledby="gridSystemModalLabel">
        </div>
