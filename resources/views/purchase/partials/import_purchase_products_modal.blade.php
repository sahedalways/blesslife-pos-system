<div class="modal fade"
     tabindex="-1"
     role="dialog"
     id="import_purchase_products_modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div id="import_product_dz"
                             class="dropzone"></div>
                    </div>
                    <div class="col-md-12 mt-10">
                        <a href="{{ asset('files/import_purchase_products_template.xls') }}"
            ...
            <div class="modal-footer">
                <button type="button"
                        ...
                        id="import_purchase_products"> @lang('lang_v1.import')</button>
                <button type="button"
