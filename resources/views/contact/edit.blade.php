<div class="modal-dialog modal-lg"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-15">
                    <label class="radio-inline">
                        <input type="radio"
                               ...
                               @if ($contact->contact_type == 'individual') checked @endif
                               id="inlineRadio1"
                               value="individual">
                    ...
                    <label class="radio-inline">
                        <input type="radio"
                               name="contact_type_radio"
                               @if ($contact->contact_type == 'business') checked @endif
                               id="inlineRadio2"
                               value="business">
                ...
                <div class="col-md-4 business"
                     @if ($contact->contact_type == 'individual' || empty($contact->contact_type)) style="display: none;" @endif>
                    <div class="form-group">
                ...
                <div class="col-md-3 individual"
                     @if ($contact->contact_type == 'business' || empty($contact->contact_type)) style="display: none;" @endif>
                    <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="form-group individual"
                         @if ($contact->contact_type == 'business') style="display: none;" @endif>
                ...
                <div class="col-md-12">
                    <button type="button"
                            class="tw-dw-btn tw-dw-btn-primary tw-text-white center-block more_btn"
                    ...
                    <div class="col-md-4 customer_fields">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('cr_no', $contact->cr_no ?? null, [
                                    'class' => 'form-control',
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('land_mark', $contact->land_mark, [
                                    'class' => 'form-control',
                                    'placeholder' => __('business.land_mark'),
                                ]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('street_name', $contact->street_name, [
                                    'class' => 'form-control',
                                    'placeholder' => __('business.street_name'),
                                ]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('building_number', $contact->building_number, [
                                    'class' => 'form-control',
                                    'placeholder' => __('business.building_number'),
                                ]) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('additional_number', $contact->additional_number, [
                                    'class' => 'form-control',
                                    'placeholder' => __('business.additional_number'),
                                ]) !!}
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-footer">
            <button type="submit"
                    class="tw-dw-btn tw-dw-btn-primary tw-text-white">@lang('messages.update')</button>
            <button type="button"
