...
@section('content')
    ...
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('lang_v1.edit_purchase_order') <i
               class="fa fa-keyboard-o hover-q text-muted"
               aria-hidden="true"
               data-container="body"
               data-toggle="popover"
    ...
    <section class="content">
        ...
        <input type="hidden"
               id="p_code"
               value="{{ $currency_details->code }}">
        <input type="hidden"
               id="p_symbol"
               value="{{ $currency_details->symbol }}">
        <input type="hidden"
               id="p_thousand"
               value="{{ $currency_details->thousand_separator }}">
        <input type="hidden"
               id="p_decimal"
               value="{{ $currency_details->decimal_separator }}">

        @include('layouts.partials.error')

        {!! Form::open([
            'url' => action([\App\Http\Controllers\PurchaseOrderController::class, 'update'], [$purchase->id]),
            'method' => 'PUT',
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button type="button"
                                        class="btn btn-default bg-white btn-flat add_new_supplier"
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('purchase_requisition_ids[]', $purchase_requisitions, $purchase->purchase_requisition_ids, [
                                'class' => 'form-control select2',
                                'multiple',
                    ...
                    <div class="pull-right col-md-5">
                        <table class="pull-right col-md-12">
                            ...
                            <tr class="hide">
                                ...
                                <td class="col-md-5 text-left">
                                    <span id="total_st_before_tax"
                                          class="display_currency"></span>
                                    <input type="hidden"
                                           id="st_before_tax_input"
                                           value=0>
                                </td>
                            </tr>
                            <tr>
        ...
        @component('components.widget', ['class' => 'box-solid'])
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-8">
                    ...
                    <b>@lang('lang_v1.order_total'): </b><span id="grand_total"
                          class="display_currency"
                ...
                <div class="col-sm-12">
                    <table class="table">
                        <tr class="hide">
                            ...
                            <td class="col-md-3">
                                <b>Discount:</b>(-)
                                <span id="discount_calculated_amount"
                                      class="display_currency">0</span>
                            </td>
                        </tr>
                        <tr class="hide">
                            <td>
    ...
    <!-- /.content -->
    <!-- quick product modal -->
    <div class="modal fade quick_add_product_modal"
         tabindex="-1"
         role="dialog"
         aria-labelledby="modalTitle"></div>
