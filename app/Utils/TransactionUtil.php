...
class TransactionUtil extends Util
{
    ...
    public function getReceiptDetails($transaction_id, $location_id, $invoice_layout, $business_details, $location_details, $receipt_printer_type)
    {
        ...
        //Expose raw sell custom fields for custom templates,
        //even when the invoice layout toggle is disabled.
        $output['custom_field_1'] = $transaction['custom_field_1'] ?? null;
        $output['custom_field_1_label'] = $custom_labels->sell->custom_field_1 ?? null;
    ...
    public function getListSells($business_id, $sale_type = 'sell', $only_count = false)
    {
        ...
        ")
                ...
                ->select(
                    ...
                    'transactions.final_total',
                    'transactions.tax_amount',
                    'contacts.cr_no as customer_cr_no',
                    'contacts.tax_number',
