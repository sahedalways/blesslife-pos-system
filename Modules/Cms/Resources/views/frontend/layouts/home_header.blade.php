...
@media (max-width: 768px) {
    ...
    .hero-carousel .carousel-caption h1 { font-size: 1.75rem; }
    .hero-carousel .carousel-caption p { font-size: 0.95rem; }
    .hero-carousel .btn-trial { padding: 0.7rem 1.8rem; font-size: 0.95rem; }
}
</style>
...
<div id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel" data-bs-interval="6000">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active" style="background-image: url('https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1600&q=80');">
            <div class="carousel-caption">
                <h1 class="typewriter" data-text="Streamline Your Business with Ultimate POS"></h1>
                <p>From inventory to sales — one integrated platform to manage your entire retail operation seamlessly.</p>
                <a href="{{ $hero_btn['link'] ?? route('business.getRegister') }}" class="btn-trial">{{ $hero_btn['text'] ?? 'Start your Free Trial' }}</a>
            </div>
        </div>
        <div class="carousel-item" style="background-image: url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600&q=80');">
            <div class="carousel-caption">
                <h1 class="typewriter" data-text="Real-Time Insights, Smarter Decisions"></h1>
                <p>Powerful analytics and reporting give you full visibility into your business performance at a glance.</p>
                <a href="{{ $hero_btn['link'] ?? route('business.getRegister') }}" class="btn-trial">{{ $hero_btn['text'] ?? 'Start your Free Trial' }}</a>
            </div>
        </div>
        <div class="carousel-item" style="background-image: url('https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?w=1600&q=80');">
            <div class="carousel-caption">
                <h1 class="typewriter" data-text="Multi-Store Management Made Easy"></h1>
