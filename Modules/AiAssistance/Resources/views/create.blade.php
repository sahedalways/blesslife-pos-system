...
<section class="content no-print">
    <div class="alert alert-warning" style="font-size: 1.1em;">
        ...
        {{ __('aiassistance::lang.sensitive_data_warning') }}
    </div>
    <div class="row">
        <form action="{{action([\Modules\AiAssistance\Http\Controllers\AiAssistanceController::class, 'generate'], ['tool' => $tool_details['name']])}}" method="POST" id="create_form">
            ...
            <div class="box box-success box-solid">
                    ...
                    <div class="box-body">
                        @if(!empty($tool_details['example']))
                            <div class="col-md-12">
                                <div class="form-group">
                                    <p class="help-block" style="margin-top: 10px;">{{ $tool_details['example'] }}</p>
                                </div>
                            </div>
                        @endif
                        ...
                        @if($tool_details['name'] == 'customer_support_reply')
                        <div class="col-md-12">
                            <div class="form-group">
                                {!! Form::label('customer_message', __( 'aiassistance::lang.customer_message' ) . ':*') !!}
                                {!! Form::textarea('customer_message', null, ['class' => 'form-control',
                                'placeholder' => __( 'aiassistance::lang.customer_message' ), 'rows' => 3, 'required', 'maxlength' => 200]); !!}
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-5 pull-right">
                            <button type="reset" class="tw-dw-btn tw-dw-btn-neutral tw-text-white">@lang( 'aiassistance::lang.reset' )</button>

                            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white pull-right ladda-button" id="submit_btn">@lang( 'aiassistance::lang.create' )</button>
                        </div>
                    </div>
